...
#api_key='dca34d6ddc96f54ba1d0a5d529bd1ed861eb4885'
...
while input_text != 'Q': #Q를 누르면 종료
    ...
    if input_text != 'Q':
        response = alchemyapi.concepts('text', input_text,options={'maxRetrieve': input_maxC})
        ...
        if response['status'] == 'OK':
            ...
            response = alchemyapi.keywords('text', input_text, options={'maxRetrieve': input_maxC})
            print('## Keywords ##')
            rel_temp=[]
